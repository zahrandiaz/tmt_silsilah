<div x-data="{ showModal: false, largeImageUrl: '' }" @keydown.escape.window="showModal = false">
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li class="inline-flex items-center">
                        <a href="{{ auth()->check() ? route('people.index') : route('silsilah.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
            ...
            {{-- BLOK PASANGAN & KETURUNAN YANG SUDAH DIPERBAIKI --}}
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
